...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO kasus (id, siswa_id, jenis_id, note, date) VALUES (null, ?, ?, ?, ?)";
    ...
    if ($stmt->execute()) {
        ...
        echo "<script>
                alert('Gagal menyimpan catatan kasus.');
                window.location.href = '/BK/users/user-guru/kasus/create.php';
              </script>";
        exit();
    }
}
